# Release Checklist — School Inventory Manager v0.2.0
...
git status
git add .
git commit -m "Prepare v0.2.0 release documentation"
...
```text
School Inventory Manager v0.2.0 — Android scanner and mobile findings workflow
```
