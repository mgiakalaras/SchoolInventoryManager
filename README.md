...
**School Inventory Manager** είναι μια web εφαρμογή για σχολική απογραφή Η/Υ, ψηφιακών μέσων και λοιπού τεχνολογικού εξοπλισμού.
...
> Τρέχουσα φάση: MVP / school testing  
> Προτεινόμενη χρήση: τοπικό σχολικό δίκτυο, όχι δημόσια έκθεση στο Internet
